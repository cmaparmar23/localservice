			...
			<div class="row">
				<div class="col-md-4">
					<div class="single-sidebar">
						<h2 class="sidebar-title">Search Service</h2>
						<form action="">
					...
					<div class="single-sidebar">
						...
						<div class="thubmnail-recent">
							<img src="img/product-thumb-1.jpg" class="recent-thumb" alt="">
							<h2>
								<a href=""><%=service.getName() %></a>
							</h2>
							<div class="product-sidebar-price">
								<ins><%=service.getPrice() %></ins>
								<del><%=service.getPrice()+(service.getPrice()) %></del>
							</div>
						</div>
						<div class="thubmnail-recent"> 
							<img src="img/product-thumb-1.jpg" class="recent-thumb" alt="">
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="product-images">
									<div class="product-main-img">
										<img src="assets/users/products/main.jpg" alt="">
									</div>
							...
							<div class="col-sm-6">
								<div class="product-inner">
									<h2 class="product-name"><%=service.getName() %></h2>
									<div class="product-inner-price">
										<ins><%=service.getPrice() %></ins>
										<del><%=service.getPrice()+(service.getPrice()) %></del>
									</div>

									<form action="mycart" class="cart">
										<div class="quantity">
									...
									<div class="product-inner-category">
										<p>
										 Category:<a href=""><%=service.getCategoryName()%></a>.
										SubCategory:<a href=""><%=service.getSubCategoryName()%> </a>
										</p>
									</div>
											...
											<div class="single-product">
												<div class="product-f-image">
													...
													<div class="product-hover">
														<a href=" <a href="addtocart?serviceId<%= service.getServiceId() %>" 
										<i>
