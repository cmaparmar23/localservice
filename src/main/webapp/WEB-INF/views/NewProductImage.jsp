...
<title>eComApp | New Service Image</title>
			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-body">
						...
						<%
							List<ServiceBean> list = (List<ServiceBean>) request.getAttribute("Services");
						%>

						<form action="saveServiceimage" method="post">
							<div class="row mb-3">
								<label for="inputText" class="col-sm-2 col-form-label">ImageURL
								</label>
								<div class="col-sm-6">
									<input type="text" name="imageUrl" class="form-control"
									value="assets/users/Services/">
								</div>
							</div>
							...
							<div class="row mb-3">
								...
								<div class="col-2">
									<a class="btn btn-danger w-100" href="listServiceimage"
